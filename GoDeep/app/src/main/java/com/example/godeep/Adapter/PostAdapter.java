...
import com.example.godeep.CommentActivity;
import com.example.godeep.Modal.Notification;
import com.example.godeep.Modal.Post;
import com.example.godeep.Modal.User;
import com.example.godeep.R;
import com.example.godeep.databinding.DashboardRvBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.viewHolder>{
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        try{
        Boolean b = FirebaseDatabase.getInstance().getReference().child("posts").child(model.getPostId()).child("likes").child(FirebaseAuth.getInstance().getUid()).equals(false);}
